 ...
 */
require_once "M2b/Auth/OpenID.php";
require_once "M2b/Auth/OpenID/Message.php";
require_once "M2b/Auth/OpenID/HMAC.php";
require_once "M2b/Auth/OpenID/Association.php";
require_once "M2b/Auth/OpenID/CryptUtil.php";
require_once "M2b/Auth/OpenID/DiffieHellman.php";
require_once "M2b/Auth/OpenID/KVForm.php";
require_once "M2b/Auth/OpenID/Nonce.php";
require_once "M2b/Auth/OpenID/Discover.php";
require_once "M2b/Auth/OpenID/URINorm.php";
require_once "M2b/Auth/Yadis/Manager.php";
require_once "M2b/Auth/Yadis/XRI.php";
...
class Auth_OpenID_GenericConsumer {
	 ...
	 * @access private
	 */
	var $openid1_nonce_query_arg_name = 'social_connect_none';
