...
require_once 'M2b/Auth/Yadis/XML.php';
require_once 'M2b/Auth/OpenID/Consumer.php'; // For Auth_OpenID_FailureResponse
...
class Auth_OpenID_Message {
	...
	{
		$form = "<form accept-charset=\"UTF-8\" style='display:none;' ".
