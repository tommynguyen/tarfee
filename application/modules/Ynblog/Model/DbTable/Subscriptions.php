<?php 
class Ynblog_Model_DbTable_Subscriptions extends Engine_Db_Table
{
  /*----- Properties -----*/
  protected $_name = 'blog_subscriptions';

  /*----- Set Notification Function -----*/
  public function sendNotifications(Ynblog_Model_Blog $blog)
  {
    ...
    foreach( $users as $user ) {
      $notificationTable->addNotification($user, $owner, $blog, 'ynblog_subscribed_new');
    }
