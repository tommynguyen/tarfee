...
Element.Properties.slideshow = {
	...
	set: function(options){
		this.get('slideshowynblog').setup(options);
		return this;
	},

	get: function(){
		var instance = this.retrieve('slideshowynblog');
		if (!instance){
			instance = new SlideShow(this, {}, true);
			this.store('slideshowynblog', instance);
		}
		return instance;
	}
...
Element.implement({
	...
	playSlideShow: function(options){
		this.get('slideshowynblog').setup(options).play();
		return this;
	},

	pauseSlideShow: function(){
		this.get('slideshowynblog').pause();
		return this;
	}
