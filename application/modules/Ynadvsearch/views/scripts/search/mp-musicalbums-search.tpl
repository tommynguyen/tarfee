<script type='text/javascript'>
    ...
    var loadContents = function(url)
    {
        ...
        var ajax_params = {};
        if (url == '') {
            url = en4.core.baseUrl + 'widget/index/name/mp3music.browse-albums';
            ajax_params = params;
        }
        ...
        var request = new Request.HTML({
            ...
            onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript)
            {
                ...
                if($('ynadvsearch_content_result')) 
                {
                    ...
                    if ($$('.layout_mp3music_browse_albums h3')[0]) {
                        $$('.layout_mp3music_browse_albums h3')[0].destroy();
                    }
                }
...
<div id="ynadvsearch_result" style="display: none">
	<div class='count_results ynadvsearch-clearfix'>
		...
		<span class="label_results"><?php echo $this->htmlLink(array('route' => 'mp3music_browsealbums'), ucfirst($this->label_content), array());?></span>
	</div>
</div>
