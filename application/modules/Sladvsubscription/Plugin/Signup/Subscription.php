 ...
 */
class Sladvsubscription_Plugin_Signup_Subscription extends Core_Plugin_FormSequence_Abstract
{
  ...
  protected $_script = array('_signupSubscription.tpl', 'sladvsubscription');

  protected $_adminFormClass = 'Sladvsubscription_Form_Admin_Signup_Subscription';
  ...
  public function onAdminProcess($form)
  {
    ...
    $step_row = $step_table->fetchRow($step_table->select()->where('class = ?', 'Sladvsubscription_Plugin_Signup_Subscription'));
