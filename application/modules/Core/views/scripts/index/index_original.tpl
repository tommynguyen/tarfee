...
<html lang="en">
  <head>
	...
	<!-- favicon -->
	<!-- Bootstrap core CSS -->
	<link href="//tarfee.com/landing/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<!-- Bootstrap theme -->
	<link href="//tarfee.com/landing/assets/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet">
	<!-- vegas bg -->
	<link href="//tarfee.com/landing/assets/js/vegas/jquery.vegas.min.css" rel="stylesheet">
	<!-- owl carousel css -->
	<link href="//tarfee.com/landing/assets/js/owl-carousel/owl.carousel.css" rel="stylesheet">
	<link href="//tarfee.com/landing/assets/js/owl-carousel/owl.theme.css" rel="stylesheet">
	<link href="//tarfee.com/landing/assets/js/owl-carousel/owl.transitions.css" rel="stylesheet">
	<!-- intro animations -->
	<link href="//tarfee.com/landing/assets/js/wow/animate.css" rel="stylesheet">
	<!-- font awesome -->
	<link href="//tarfee.com/landing/assets/css/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<!-- lightbox -->
	<link href="//tarfee.com/landing/assets/js/lightbox/css/lightbox.css" rel="stylesheet">
	
	<!-- styles for this template -->
	<link href="//tarfee.com/landing/assets/css/styles.css" rel="stylesheet">
	
	<!-- place your extra custom styles in this file -->
	<link href="//tarfee.com/landing/assets/css/custom.css" rel="stylesheet">
  ...
  <body data-default-background-img="//tarfee.com/landing/assets/images/other_images/bg5.jpg" data-overlay="true" data-overlay-opacity="0.35">
    ...
    <div id="outer-container">
      ...
      <section id="left-sidebar">
        ...
        <div class="logo">
          <a href="#intro" class="link-scroll"><img src="//tarfee.com/photos/tarfee-logo.png" alt="Tarfee"></a>
        </div><!-- .logo -->
        <!-- ==================== END: LOGO ==================== -->
      ...
      <section id="main-content" class="clearfix">
        ...
        <article id="intro" class="section-wrapper clearfix" data-custom-background-img="//tarfee.com/photos/bg1.jpg">
        ...
        <!-- FOR EACH SECTION <article class="section-wrapper".. :
             - remember to use a unique id, 
             - (optional) set a "data-custom-background-img" attribute with a link to custom background image which will be used when the viewer scrolls to this section -->
        <article id="text" class="section-wrapper clearfix" data-custom-background-img="//tarfee.com/photos/bg2.jpg">
          <div class="content-wrapper clearfix">
            <div class="col-sm-10 col-md-9 pull-right">
              ...
              <!-- Start: Section content to edit -->
                ...
                <p class="feature-paragraph"><img data-img-src="//tarfee.com/photos/Soccer-icon-2.png" class="lazy pull-right" alt="Lorem Ipsum">Tarfee is a social network that connects football talents with football clubs, universities and scouts worldwide. We believe that every football talent deserves a chance to be noticed and recognized.</p>
        ...
        <!-- FOR EACH SECTION <article class="section-wrapper".. :
             - remember to use a unique id, 
             - (optional) set a "data-custom-background-img" attribute with a link to custom background image which will be used when the viewer scrolls to this section -->
        <article id="carousel" class="section-wrapper clearfix" data-custom-background-img="//tarfee.com/photos/bg5.jpg">
          <div class="content-wrapper clearfix">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="item active">
                    <div class="carousel-text-content">
                      ...
                      <img src="//tarfee.com/photos/t2.1.v3.png" class="icon" alt="Lorem Ipsum">
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-2">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/t2.v3.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Upload your best videos to be noticed easily by football scouts, clubs, and universities all over the world</li>
                  ...
                  <div class="item">
                    <div class="carousel-text-content">
                      <!-- start: slide content to edit -->
                      <img src="//tarfee.com/photos/t3.1.v3.png" class="icon" alt="Lorem Ipsum">
                      <!-- if you want to use bootstrap glyphicons instead, replace the above <img> with the commented <span> below -->
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-3">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/t3.v3.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Promote your organization and students, and show the world what you stand for!</li>
                  ...
                  <div class="item">
                    <div class="carousel-text-content">
                      <!-- start: slide content to edit -->
                      <img src="//tarfee.com/photos/t4.1.v3.png" class="icon" alt="Lorem Ipsum">
                      <!-- if you want to use bootstrap glyphicons instead, replace the above <img> with the commented <span> below -->
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-4">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/t4.v3.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Access the best football talents all over the world!</li>
                  ...
                  <div class="item">
                    <div class="carousel-text-content">
                      <!-- start: slide content to edit -->
                      <img src="//tarfee.com/photos/t5.1.v3.png" class="icon" alt="Lorem Ipsum">
                      <!-- if you want to use bootstrap glyphicons instead, replace the above <img> with the commented <span> below -->
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-5">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/t5.v3.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Promote your club, university, or agency in a football dedicated environment, where all football lovers gather</li>
        ...
        <!-- FOR EACH SECTION <article class="section-wrapper".. :
             - remember to use a unique id, 
             - (optional) set a "data-custom-background-img" attribute with a link to custom background image which will be used when the viewer scrolls to this section -->
        <article id="featured" class="section-wrapper clearfix" data-custom-background-img="//tarfee.com/photos/bg3.jpg">
          <div class="content-wrapper clearfix">
              <!-- Start: Section content to edit -->
                  ...
                  <div class="item active">
                    <div class="carousel-text-content">
                      ...
                      <a target="_blank" href="https://gradstudents.carleton.ca/2015/entrepreneurship-carleton-style-tim-program-leads-the-way/" ;"="">
                      	<img src="//tarfee.com/photos/press-1.jpg" class="icon" alt="Lorem Ipsum">
                      <a/>
                      <!-- if you want to use bootstrap glyphicons instead, replace the above <img> with the commented <span> below -->
                      <a target="_blank" href="https://gradstudents.carleton.ca/2015/entrepreneurship-carleton-style-tim-program-leads-the-way/" ;"="">
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-6">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/press-1.jpg" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Upload your best videos to be noticed easily by football scouts, clubs, and universities all over the world</li>
							<li>Get the best contract or scholarship</li>
							<li>Apply for tryouts and events organized by football scouts, clubs, and universities</li>
							<li>Avoid fraud and false offers by checking the ratings and reviews of scouts</li>
							<li>Connect with other players and professionals to share your experience, learn, and to get advice</li></p>
                  ...
                  <div class="item">
                    <div class="carousel-text-content">
                      ...
                      <a target="_blank" href="http://newsroom.carleton.ca/2015/02/12/go-global-hire-local-matches-technology-venture-teams-talented-professionals-carleton-university/" ;">
                      	<img src="//tarfee.com/photos/press-2.jpg" class="icon" alt="Lorem Ipsum">
                      </a>
                      <!-- if you want to use bootstrap glyphicons instead, replace the above <img> with the commented <span> below -->
                      <a target="_blank" href="http://newsroom.carleton.ca/2015/02/12/go-global-hire-local-matches-technology-venture-teams-talented-professionals-carleton-university/" ;">
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-7">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/press-2.jpg" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Promote your organization and students, and show the world what you stand for!</li>
                        <li>Create player profile for each student and upload his/her videos and information</li>
                        <li>Be engaged with your community, kids, and their parents</li>
                        <li>Create events and tryouts and invite people to join</li>
                        <li>Directly send and receive message from followers</li>
                  ...
                  <div class="item">
                    <div class="carousel-text-content">
                      ...
                      <a target="_blank" href="http://newsroom.carleton.ca/2014/12/24/carleton-students-present-startups-philanthropist-entrepreneur-wes-nicol/">
                      	<img src="//tarfee.com/photos/press-3.jpg" class="icon" alt="Lorem Ipsum">
                      </a>
                      <!-- if you want to use bootstrap glyphicons instead, replace the above <img> with the commented <span> below -->
                      <!-- <span class="icon glyphicon glyphicon-lock"></span> -->
                      <a target="_blank" href="http://newsroom.carleton.ca/2014/12/24/carleton-students-present-startups-philanthropist-entrepreneur-wes-nicol/">
                      ...
                      <div class="content-to-populate-in-modal" id="modal-content-8">
                        ...
                        <p><img data-img-src="//tarfee.com/photos/press-3.jpg" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum"><li>Access the best football talents all over the world!</li>
                        <li>Find exactly what you are looking for quickly and easily: You can customize your search by filtering by age, country, position, rating, etc.</li>
                        <li>Keep eye on the players you like to follow their improvements</li>
                        <li>Direct messaging: Just find the players you are looking for and send them a message</li>
                        <li>Create events & tryouts and invite players to join and submit their profiles</li>
        ...
        <!-- FOR EACH SECTION <article class="section-wrapper".. :
             - remember to use a unique id, 
             - (optional) set a "data-custom-background-img" attribute with a link to custom background image which will be used when the viewer scrolls to this section -->
        <article id="tabs" class="section-wrapper clearfix" data-custom-background-img="//tarfee.com/photos/bg6.jpg">
                ...
                <div class="tabpanel styled-tabs uniform-height" role="tabpanel">
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="tabs-tab1">
                      <img src="//tarfee.com/photos/Canada.png" class="pull-right hidden-xs">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabs-tab2">
                      <img src="//tarfee.com/landing/assets/images/other_images/tabs-icon3.png" class="pull-right hidden-xs">
                      <h4>Our Values</h4>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabs-tab3">
                      <img src="//tarfee.com/landing/assets/images/other_images/tabs-icon2.png" class="pull-right hidden-xs">
                      <h4>Tarfee Team</h4>
                      <p>Nunc accumsan sapien eu tortor fringilla, et condimentum metus pellentesque. Maecenas rhoncus tortor nec mi congue aliquet. Integer eu turpis scelerisque, iaculis magna non, tempor sem. Quisque consectetur nisi eu felis euismod, sit amet faucibus justo molestie. Ut pretium sapien dui, id facilisis metus interdum pharetra.</p>
                    </div>

                    <div role="tabpanel" class="tab-pane fade" id="tabs-tab4">
                      <a target="_blank" href="http://timprogram.ca"><img src="//tarfee.com/photos/logo1.v2.png" class="pull-right hidden-xs"></a>
                    	<a target="_blank" href="http://leadtowin.ca"><img src="//tarfee.com/photos/logo3.v1.png" class="pull-right hidden-xs"></a>
                    	<a target="_blank" href="http://carleton.ca"><img src="//tarfee.com/photos/logo2.v2.png" class="pull-right hidden-xs"></a>
        ...
        <!-- FOR EACH SECTION <article class="section-wrapper".. :
             - remember to use a unique id, 
             - (optional) set a "data-custom-background-img" attribute with a link to custom background image which will be used when the viewer scrolls to this section -->
        <article id="contact" class="section-wrapper clearfix" data-custom-background-img="//tarfee.com/landing/assets/images/other_images/bg4.jpg">
          <div class="content-wrapper clearfix">
              ...
              <h1 class="section-title">Contact</h1>
                ...
                <div class="col-sm-7 col-md-9">
                  <!-- IMPORTANT: change the email address at the top of the //tarfee.com/landing/assets/php/mail.php file to the email address that you want this form to send to -->
                  <form class="form-style validate-form clearfix" action="//tarfee.com/landing/assets/php/mail.php" method="POST" role="form">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group text-right">
                        <img id="form-captcha-img" src="//tarfee.com/landing/assets/php/form_captcha/captcha_img.php">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <img src="//tarfee.com/landing/assets/images/theme_images/loader-form.GIF" class="form-loader">
      ...
      <section id="footer">
        ...
        <!-- Each social icon item consists of the following:
             ...
             - social icon in the <img> - a list of social icons options are found in the directory //tarfee.com/landing/assets/images/theme_images/social_icons/ -->
        <ul class="social-icons">
          <li><a href="https://www.facebook.com/TarfeeInc" target="_blank" title="Facebook"><img src="//tarfee.com/landing/assets/images/theme_images/social_icons/facebook.png" alt="Facebook"></a></li>
          <li><a href="https://twitter.com/tarfeeinc" target="_blank" title="Twitter"><img src="//tarfee.com/landing/assets/images/theme_images/social_icons/twitter.png" alt="Twitter"></a></li>
        </ul>
        <!-- ==================== END: Social Icons ==================== -->
    ...
    <script>window.jQuery || document.write('<script src="//tarfee.com/landing/assets/js/jquery-1.11.2.min.js"><\/script>')</script>
    <script src="//tarfee.com/landing/assets/bootstrap/js/bootstrap.min.js"></script>

    <!-- Easing - for transitions and effects -->
    <script src="//tarfee.com/landing/assets/js/jquery.easing.1.3.js"></script>

    <!-- background image strech script -->
    <script src="//tarfee.com/landing/assets/js/vegas/jquery.vegas.min.js"></script>

    <!-- detect mobile browsers -->
    <script src="//tarfee.com/landing/assets/js/detectmobilebrowser.js"></script>

    <!-- detect scrolling -->
    <script src="//tarfee.com/landing/assets/js/jquery.scrollstop.min.js"></script>

    <!-- owl carousel js -->
    <script src="//tarfee.com/landing/assets/js/owl-carousel/owl.carousel.min.js"></script>

    <!-- lightbox js -->
    <script src="//tarfee.com/landing/assets/js/lightbox/js/lightbox.min.js"></script>

    <!-- intro animations -->
    <script src="//tarfee.com/landing/assets/js/wow/wow.min.js"></script>

    <!-- responsive videos -->
    <script src="//tarfee.com/landing/assets/js/jquery.fitvids.js"></script>

    <!-- Custom functions for this theme -->
    <script src="//tarfee.com/landing/assets/js/functions.js"></script>
    <script src="//tarfee.com/landing/assets/js/initialise-functions.js"></script>
