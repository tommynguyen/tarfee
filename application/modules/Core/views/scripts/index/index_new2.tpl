...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/bootstrap.min.css" rel="stylesheet">

	<!-- Custom styles for bootstrap -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/overwrite.css" rel="stylesheet">

	<!-- Custom styles for fontawesome icon -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/font-awesome.css" rel="stylesheet">

    <!-- Flexslider -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/flexslider.css" rel="stylesheet">

    <!-- prettyPhoto -->	
	<link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/prettyPhoto.css" rel="stylesheet">	

    <!-- animate -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/animate.css" rel="stylesheet">
	
    <!-- Custom styles for this template -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/css/style.css" rel="stylesheet">
	
	<!-- Font for this template -->
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
	
	<!-- Custom styles for template skin -->
    <link href="https://www.tarfee.com/application/modules/Core/views/scripts/index/skins/default/skin.css" rel="stylesheet">
  ...
  <body>
    ...
    <script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/jquery.min.js"></script>
    <script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/bootstrap.min.js"></script>

	<!-- Fixed navigation -->
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/navigation/jquery.smooth-scroll.js"></script>	
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/navigation/navbar.js"></script>	
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/navigation/waypoints.min.js"></script>
	
	<!-- WOW JavaScript -->
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/wow.min.js"></script>
	
	<!-- JavaScript bgSlider slider -->
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/bgslider/bgSlider.js"></script>		

	<!-- Flexslider -->
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/flexslider/jquery.flexslider.js"></script>
    <script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/flexslider/setting.js"></script>

	<!-- prettyPhoto -->
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/prettyPhoto/jquery.prettyPhoto.js"></script>
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/prettyPhoto/setting.js"></script>

	<!-- Contact validation js -->
    <script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/validation.js"></script>
	
	<!-- Custom JavaScript -->
	<script src="https://www.tarfee.com/application/modules/Core/views/scripts/index/js/custom.js"></script>
