UPDATE `engine4_core_modules` SET `version` = '4.02' WHERE `name` = 'ynevent';
...
('ynevent_profile_invite_group', 'ynevent', 'Invite Groups', 'Ynevent_Plugin_Menus', '', 'ynevent_profile', '', 1, 0, 9);


INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `enabled`, `custom`, `order`) VALUES
('ynevent_admin_main_global', 'ynevent', 'Global Settings', '', '{"route":"admin_default","module":"ynevent","controller":"global"}', 'ynevent_admin_main', '', 1, 0, 2);
