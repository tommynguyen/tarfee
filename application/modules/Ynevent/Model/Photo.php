<?php
class Ynevent_Model_Photo extends Core_Model_Item_Collectible
{
	protected $_parent_type = 'ynevent_album';
	protected $_type = 'event_photo';
	protected $_owner_type = 'user';

	protected $_collection_type = 'ynevent_album';
