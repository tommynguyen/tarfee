...
<div class="ynevent_discussions_options">
  <?php echo $this->htmlLink(array('route' => 'event_profile', 'id' => $this->event->getIdentity(), 'tab' => $this -> tab), $this->translate('Back to Event'), array(
...
<ul class="ynevent_discussions">
  <?php foreach( $this->paginator as $topic ):
    ...
    <li>
      ...
      <div class="ynevent_discussions_info">
        <h3<?php if( $topic->sticky ): ?> class='ynevent_discussions_sticky'<?php endif; ?>>
          <?php echo $this->htmlLink($topic->getHref(), $topic->getTitle()) ?>
        </h3>
        <div class="ynevent_discussions_blurb">
