    ...
    var eventWidgetRequestSend = function(action, event_id, notification_id, rsvp)
    {
        ...
        (new Request.JSON({
            ...
            'onSuccess' : function(responseJSON)
            {
                ...
                {
                    $('ynevent-widget-request-' + notification_id).innerHTML = responseJSON.error;
                }
                else
                {
                    $('ynevent-widget-request-' + notification_id).innerHTML = responseJSON.message;
                }
            }
        })).send();
    }
...
<li id="ynevent-widget-request-<?php echo $this->notification->notification_id ?>">
