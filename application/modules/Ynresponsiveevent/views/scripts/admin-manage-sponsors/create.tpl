<?php
  $this->headScript()
    ...
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynresponsive1/externals/scripts/Autocompleter.js')
	->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynresponsive1/externals/scripts/Autocompleter.Local.js')
	->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynresponsive1/externals/scripts/Autocompleter.Request.js');
?>
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter2.Request.JSON('to', '<?php echo $this->url(array('module' => 'ynresponsiveevent', 'controller' => 'manage-sponsors', 'action' => 'suggest'), 'admin_default', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
      ...
      new Composer.OverText(document.getElementById('to'), {
        'textOverride' : '<?php echo $this->translate('Start typing event name...') ?>',
        'element' : 'label',
        'isPlainText' : true,
        'positionOptions' : {
