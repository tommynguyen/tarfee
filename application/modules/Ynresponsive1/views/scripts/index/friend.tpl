...
var doConfirm = function(rid)
  {
      ...
      var img_loading = '<?php echo $this->baseUrl(); ?>/application/modules/Ynresponsive1/externals/images/loading_friend.gif';
      $('friend_action_'+rid).innerHTML = '<center><img src="'+ img_loading +'" border="0" /></center>';
      new Request.HTML({
           'url'    :    en4.core.baseUrl + 'ynresponsive1/index/confirm-friend/',
           'data' : {
                'format' : 'html',
                'resource_id' : rid
            },
  ...
  var doCancel = function(rid)
  {
      ...
      $('friend_action_'+rid).innerHTML = '<center><img src="'+ img_loading +'" border="0" /></center>';
      new Request.HTML({
           'url'    :    en4.core.baseUrl + 'ynresponsive1/index/cancel-friend/',
           'data' : {
                'format' : 'html',
                'resource_id' : rid
            },
