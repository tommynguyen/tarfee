 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Ynresponsive1_View_Helper_Navigation_Menu
    extends Zend_View_Helper_Navigation_HelperAbstract
{
                                          ...
                                          $maxDepth)
    {
        ...
        foreach ($active['page'] as $subPage) {
            ...
            ++ $index;
            $liClass = $subPage->isActive(true) ? ' class="active li-indexing-'.$index.'"' : ' class="li-indexing-'.$index.'"';
                                   ...
                                   $onlyActive)
    {
        ...
        foreach ($iterator as $page) {
            ...
            ++ $indexing;
            $liClass = $isActive ? ' class="active li-indexing-'.$indexing.'"' : ' class="li-indexing-'.$indexing.'"';
                               ...
                               array $options = array())
    {
        ...
        if($container->count() >2)
        {
          ...
          $container->addPage(array('label'=>'More','class'=>'nest_more','order'=>2,'uri'=>'#','pages'=>$pages));
        }
