 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Ynresponsive1_View_Helper_Navigation
extends Zend_View_Helper_Navigation_HelperAbstract
{
   ...
   * @var string
   */
  const NS = 'Ynresponsive1_View_Helper_Navigation';
  ...
  public function findHelper($proxy, $strict = true)
  {
    ...
    {
        $this -> view -> addHelperPath(APPLICATION_PATH . '/application/modules/' . str_replace('_', '/', self::NS), self::NS);
    }
    ...
    else
    {
      ...
      {
        $helper = $this -> view -> getHelper($proxy);
        //defined('YN_DEBUG')  and var_dump($helper); exit;
      }
    ...
    if (!$helper instanceof Zend_View_Helper_Navigation_Helper)
    {
      if ($strict)
      {
        ...
        throw new Zend_View_Exception(sprintf('Proxy helper "%s" is not an instance of ' . 'Zend_View_Helper_Navigation_Helper', get_class($helper)));
      }
