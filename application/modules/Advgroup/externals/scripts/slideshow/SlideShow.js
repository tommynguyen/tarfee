...
Element.Properties.slideshow = {
	...
	set: function(options){
		this.get('slideshowgroup').setup(options);
		return this;
	},

	get: function(){
		var instance = this.retrieve('slideshowgroup');
		if (!instance){
			instance = new SlideShow(this, {}, true);
			this.store('slideshowgroup', instance);
		}
		return instance;
	}
...
Element.implement({
	...
	playSlideShow: function(options){
		this.get('slideshowgroup').setup(options).play();
		return this;
	},

	pauseSlideShow: function(){
		this.get('slideshowgroup').pause();
		return this;
	}
