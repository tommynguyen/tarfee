...
<div class="yn_group_activity" <?php if($this->widget_height > 0):?> style="max-height:<?php echo $this->widget_height;?>px"<?php endif;?>>
      <?php if( $this->activity_count == 0 ):?>
              <div class="tip">
              <span>
                <?php echo $this->translate("There are no public group actitivies yet.");?>
              </span>
              </div>
          </div>    
      <?php   return;
              else:
                $actions = $this->group_actions;
              endif;?>

      <ul class='feed' id="yn-group-activity-feed">
     ...
     <div class="feed_viewmore" id="yn_group_feed_viewmore" style="display: none;">
      <?php echo $this->htmlLink('javascript:void(0);', $this->translate('View More'), array(
        'id' => 'yn_group_feed_viewmore_link',
        'class' => 'buttonlink icon_viewmore'
      )) ?>
    </div>
  
    <div class="feed_viewmore" id="yn_group_feed_loading" style="display: none;">
