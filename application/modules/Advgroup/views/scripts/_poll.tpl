...
<?php
  $this->headScript()
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Advgroup/externals/scripts/core.js');
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    var initializePoll = function() {
      en4.poll.urls.vote = '<?php echo $this->url(array('controller' => 'poll','action' => 'vote'), 'group_extended') ?>';
    ...
    if( $type(en4) == 'object' && 'poll' in en4 ) {
      ...
      new Asset.javascript(en4.core.staticBaseUrl + 'application/modules/Advgroup/externals/scripts/core.js', {
        onload: function() {
          initializePoll();
        }
      });
