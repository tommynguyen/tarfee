<?php
  $this->headScript()
    ...
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Advgroup/externals/scripts/Autocompleter.js')
	->appendFile($this->layout()->staticBaseUrl . 'application/modules/Advgroup/externals/scripts/Autocompleter.Local.js')
	->appendFile($this->layout()->staticBaseUrl . 'application/modules/Advgroup/externals/scripts/Autocompleter.Request.js');
?>
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter2.Request.JSON('to', '<?php echo $this->url(array('controller' => 'member', 'action' => 'suggest','group_id'=>$this->group_id), 'group_extended', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
