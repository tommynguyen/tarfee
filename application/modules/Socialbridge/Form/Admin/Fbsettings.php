...
class Socialbridge_Form_Admin_Fbsettings extends Engine_Form
{
  public function init()
  {
	...
	$this -> addElement('Text', 'max_invite_day', array(
			...
			'description' => 'The maximum number of messages will be sent per day for 1 account (Enter a number between 1 and 20)<br>More Info: <a href="http://developers.facebook.com/docs/chat/" target="_blank"> Facebook Chat API</a>',
