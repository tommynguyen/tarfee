(function() {// START NAMESPACE
	...
	ComposerYnActivityComment = new Class({
		...
		attach : function() {
			...
			if (supportsContentEditable) {
				...
				this.selection = new ComposerYnActivityComment.Selection(this.elements.body);
			} else {
				this.elements.textarea.setStyle('display', '');
			}

			if (this.options.overText && supportsContentEditable) {
				new ComposerYnActivityComment.OverText(this.elements.body, $merge({
		...
		editorClick : function(e) {
			...
			if(!this.elements.body.hasClass("yncommnet_click_textarea"))
			{
			...
			if (e.key == 'esc') {
				...
				if (this.getForm().comment_id && this.getForm().comment_id.value) {
					if ($('comments_body_' + this.getForm().comment_id.value)) {
						$('comments_body_' + this.getForm().comment_id.value).style.display = 'block';
					}
				...
				if (this.getForm().comment_id && this.getForm().comment_id.value) {
					if ($('reply_body_' + this.getForm().comment_id.value)) {
						$('reply_body_' + this.getForm().comment_id.value).style.display = 'block';
					}
		        ...
		        if($('yncomment_comments_attachment_' + this.getForm().comment_id.value))
		            $('yncomment_comments_attachment_' + this.getForm().comment_id.value).style.display = 'block';
        		if( $('close_edit_box-' + this.getForm().comment_id.value))
	...
	ComposerYnActivityComment.Selection = new Class({
	...
	ComposerYnActivityComment.OverText = new Class({
	...
	ComposerYnActivityComment.Plugin = {};

	ComposerYnActivityComment.Plugin.Interface = new Class({
