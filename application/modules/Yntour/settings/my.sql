...
CREATE TABLE IF NOT EXISTS `engine4_yntour_tours` (
...
CREATE TABLE IF NOT EXISTS `engine4_yntour_touritems` (
...
ALTER TABLE  `engine4_yntour_touritems` CHANGE  `dompath`  `dompath` LONGTEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;