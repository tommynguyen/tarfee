...
<script type="text/javascript">
   ...
   var updateTextFields = window.updateTextFields = function() {
			...
			var reason_element = document.getElementById("reason-wrapper");
           ...
           // $('add-wrapper').style.display = "none";
            ...
            if( type_element.value == 1 ) {
                //$('email').value = "";
                reason_element.style.display = "none";
                return;
            } else  if( type_element.value == 2 ) {
                reason_element.style.display = "block";
                return;
            }  else {
               // $('ip').value = "";
               reason_element.style.display = "none";
