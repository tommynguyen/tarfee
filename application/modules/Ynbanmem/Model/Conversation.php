...
class Ynbanmem_Model_Conversation extends Core_Model_Item_Abstract
{
  protected $_searchTriggers = false;
	protected $_name = 'messages_conversation';
  ...
  public function getOutboxMessage(User_Model_User $user)
  {
    ...
    $message = Engine_Api::_()->getItem('messages_message', $recipient->outbox_message_id);
