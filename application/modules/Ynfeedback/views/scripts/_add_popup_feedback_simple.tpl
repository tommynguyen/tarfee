...
<?php if($isAllow) :?>
            ...
            <?php if($viewer -> getIdentity()) :?>
            	...
            	<div id='auth_view_popup-wrapper' class='form-wrapper'>
					<div id='auth_view_popup-label' class='form-label'>
						<label for='auth_view_popup' class='optional'><?php echo $this -> translate('Feedback Privacy');?></label>
					</div>
    ...
    <div class='ynfeedback-popup-simple-footer'>
        <a name='simple_create_back' id='simple_create_back'><i class='fa fa-arrow-left'></i> <?php echo $this -> translate('Back');?></a>
        <button name='simple_create' id='simple_create'><?php echo $this -> translate('Send feedback');?></button>        
    </div>
<?php else:?>
	<div class='tip'>
