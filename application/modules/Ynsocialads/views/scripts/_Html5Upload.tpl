 <?php
	...
	$staticBaseUrl = $this->layout()->staticBaseUrl;
 	$this->headLink() 
 	->prependStylesheet($staticBaseUrl . 'application/modules/Ynsocialads/externals/styles/bootstrap.css')
	->prependStylesheet($staticBaseUrl . 'application/modules/Ynsocialads/externals/styles/upload_photo/jquery.fileupload.css');
		
	$this->headScript()
  	->appendFile($staticBaseUrl . 'application/modules/Ynsocialads/externals/scripts/jquery-1.7.1.min.js')	
	->appendScript('jQuery.noConflict();')
  	->appendFile($staticBaseUrl . 'application/modules/Ynsocialads/externals/scripts/js/vendor/jquery.ui.widget.js')	
  	->appendFile($staticBaseUrl . 'application/modules/Ynsocialads/externals/scripts/js/jquery.iframe-transport.js')
	->appendFile($staticBaseUrl . 'application/modules/Ynsocialads/externals/scripts/js/jquery.fileupload.js')	
	->appendFile($staticBaseUrl . 'application/modules/Ynsocialads/externals/scripts/bootstrap.js')		
;	
 ?>
 <div id="file-wrapper">
...
jQuery(function () 
{
    ...
    <?php
		$url =  $this->url(array('module'=>'ynsocialads','controller'=>'photo','action'=>'upload-photo'), 'default');
    ?>
...
{
	<?php
		$deleteUrl = $this->url(array('module'=>'ynsocialads','controller'=>'photo','action'=>'delete-photo'), 'default');
	?>
	new Request.JSON({
