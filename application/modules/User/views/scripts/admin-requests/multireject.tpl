...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Reject the selected Requests?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to reject %d Requests?", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Delete the selected Requests?") ?></h3>
      <p>
        <?php echo $this->translate("Please select at least one request to reject.") ?>
      </p>
      <br/>
